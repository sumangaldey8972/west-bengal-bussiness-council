...
export const MOCK_REFERRALS: Referral[] = [
  {
    ...
    type: 'Given By Me',
    memberId: 'user_3',
    memberName: 'Souvik Sen',
    memberCompany: 'Howrah Heavy Forgings',
    memberAvatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=300&auto=format&fit=crop&q=80',
  ...
  },
  {
    ...
    type: 'Given By Me',
    memberId: 'user_5',
    memberName: 'Arnab Bhattacharya',
    memberCompany: 'Synapse Enterprise AI',
    memberAvatar: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=300&auto=format&fit=crop&q=80',
  ...
  },
  {
    ...
    type: 'Received By Me',
    memberId: 'user_2',
    memberName: 'Debashis Ganguly',
    memberCompany: 'Ganguly Heritage Tea',
    memberAvatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=300&auto=format&fit=crop&q=80',
  ...
  },
  {
    ...
    type: 'Received By Me',
    memberId: 'user_6',
    memberName: 'Rajesh Agarwal',
    memberCompany: 'Haldia Multimodal Logistics',
    memberAvatar: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=300&auto=format&fit=crop&q=80',
    clientOrProspectName: 'Head Procurement, Haldia Petrochemicals (HPL)',
    clientContact: 'procurement.head@hpl.co.in',
    serviceNeeded: 'Custom stainless steel precision valve actuators & fittings',
    date: 'Jul 28, 2026',
    status: 'Deal Closed',
